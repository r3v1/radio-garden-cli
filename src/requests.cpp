...
void get(const std::string url, std::string &buffer, bool saveJson, std::string filename)
{
    ...
    if (curl) {
        ...
        // Set the callback function to handle the data received from the HTTP request
        curl_easy_setopt(curl, CURLOPT_WRITEFUNCTION, writeCallback);

        // Set the pointer to the buffer as the data object to be passed to the callback function
